  ...
  function showSearchPrompt() {
    ...
    container.innerHTML = `
      <div class="empty-state" style="grid-column:1/-1">
        ...
        <a href="https://github.com/aliheba125/repo/blob/main/assets/PACKAGES.md" target="_blank" rel="noopener" style="display:inline-block;margin-top:0.8rem;padding:0.45rem 1rem;background:var(--accent);color:#000;font-weight:600;font-size:0.9rem;border-radius:var(--radius-md);transition:all 0.25s">View All Tools &rarr;</a>
      </div>
    `;
  }
